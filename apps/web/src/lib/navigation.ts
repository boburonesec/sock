...
export const navigationItems: NavigationItem[] = [
  ...
  { href: "/machines", title: "Stanoklar", description: "Stanoklar, mexanik biriktirish va ishlab chiqarish", icon: Wrench, section: "work", requiredPermissions: ["machines.view"] },
  { href: "/mechanic", title: "Mexanik", description: "Vazifalar va o‘lchov nazorati", icon: Wrench, section: "work", requiredPermissions: ["maintenance.view", "quality.view"] },
...
export const pageDefinitions: Record<string, PageDefinition> = {
  ...
  "/production/activities": { title: "Bajarilgan ishlar", description: "Xodimlarning bajargan ishlari" },
  "/production/defects": { title: "Nuqsonlar", description: "Nuqsonlar moduli" },
  "/machines": { title: "Stanoklar", description: "Stanoklar va ishlab chiqarish jarayonini boshqarish" },
  "/mechanic": { title: "Mexanik ish maydoni", description: "Vazifalar va o‘lchov nazorati" },
  "/warehouse": { title: "Ombor", description: "Ombor moduli" },
  "/warehouse/materials": { title: "Materiallar", description: "Materiallar moduli" },
  "/warehouse/movements": { title: "Ombor kirim-chiqim tarixi", description: "Kirim, chiqim va ko‘chirishlar" },
  ...
  "/finance/payroll": { title: "Ish haqi hisob-kitobi", description: "Xodimlar ish haqi hisob-kitobi" },
